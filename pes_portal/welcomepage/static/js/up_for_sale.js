function init_book()
{
	if(saleTable = document.getElementById("table"))
...
function make_ajax_for_borrow(event)
{
	if( event.target != event.currentTarget)
	{
		...
		alert(tr.childNodes[0].innerHTML + tr.childNodes[1].innerHTML + tr.childNodes[2].innerHTML + tr.childNodes[3].innerHTML)
